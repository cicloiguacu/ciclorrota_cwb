...
var FUSION_TABLE_ID = '1Y4LZpWgD0ZPRzPoyybqazCloZLSHrILSZESRa7UO';      // ID da Fusion Table utilizada
var LATITUDE = '-25.42773351975332';  // latitude,
var LONGITUDE = '-49.26082093381888'; // longitude e
var ZOOM = '11';                      // nível de zoom iniciais da visualização do mapa
var GEO_COLUMN = 'Geometry';                 // número da coluna com as informações geográficas, começando do zero
var QUERY_COLUMN = 'Tipo';               // número da coluna com as informações a serem filtradas, idem
...
function atualiza_mapa() {
	var preenchidas = 0,		// conta quantas checkboxes foram preenchidas
		...
		fusion_url = 'https://www.google.com/fusiontables/embedviz?viz=MAP&q=select+' + GEO_COLUMN + '+from+' + FUSION_TABLE_ID + '+where+' + QUERY_COLUMN + '+in+(CARACTERISTICAS)&h=false&lat=' + LATITUDE + '&lng=' + LONGITUDE + '&z=' + ZOOM + '&t=1&l=' + GEO_COLUMN;
